...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ2F1dGFta3VtYXI5OTUiLCJhIjoiY2w5Nzl4azZ0MDBocTNucDl2OXNhc214cCJ9.gLV5EJvt5B031klQ1_swzw';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    // Choose from Mapbox's core styles, or make your own style with Mapbox Studio
    style: 'mapbox://styles/gautamkumar995/cks5gfkx2atr018nx59iu1qv4',
    // style URL
    scrollZoom: false
...
exports.updateData = exports.addTourReview = exports.addBookmark = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var addBookmark = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            url = "http://127.0.0.1:3000/api/v2/tours/".concat(tourId, "/bookmark");
            _context2.prev = 1;
            _context2.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
          ...
          case 4:
            res = _context2.sent;
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Bookmarked tour successfully");
              location.reload(true);
            }
            _context2.next = 11;
            break;
  ...
  return function addBookmark(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
exports.addBookmark = addBookmark;
var addTourReview = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(tourId, rating, review) {
    var url, res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            url = "http://127.0.0.1:3000/api/v2/tours/".concat(tourId, "/reviews");
            _context3.next = 4;
            return (0, _axios.default)({
              method: 'POST',
              url: url,
  ...
  return function addTourReview(_x4, _x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
exports.addTourReview = addTourReview;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51M7g6WSF7TamEyf8w0Pzed4hgBEOG7kzEkGo1jtheER1sM6OAvw5yAfd1jaMvC0qNIgnQdh3biw7WpNdNHem3FDr00EJi2rOhZ');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v2/bookings/checkout-session/".concat(tourId));
          case 3:
...
var favBtn = _toConsumableArray(document.querySelectorAll('.fav__icon__btn'));
...
if (signupForm) {
  signupForm.addEventListener('click', function (e) {
    ...
    var email = document.getElementById('email').value;
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('cnf_password').value;
...
if (reviewBtn) {
  reviewBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId;
    (0, _updateSettings.addTourReview)(tourId, rating, review);
  });
}
if (favBtn) {
  favBtn.forEach(function (item) {
    item.addEventListener('click', function (e) {
      var tourId = e.target.parentNode.dataset.tourId;
      (0, _updateSettings.addBookmark)(tourId);
    });
  });
}
